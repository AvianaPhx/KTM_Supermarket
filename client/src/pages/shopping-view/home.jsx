        ...
        <Card className="w-full mt-7">
                <div className="flex items-start space-x-6">
                    <div className="flex-1 pl-4">
                        <img  alt="KTM-SuperMarket" className="rounded-full" />
                    </div>
                    <div className=" flex-1 mt-7 space-x-2 space-y-4 flex-grow">
                        ...
                        <div>
                            <button className="border-2 border-double border-black mt-7 px-4 py-2 bg-transparent text-black rounded-full hover:bg-black hover:text-white" onClick={handleClick} > 
                                About Us
                            </button>
                        </div>
                    </div>
